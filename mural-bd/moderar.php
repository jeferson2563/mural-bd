...
if(isset($_POST['atualiza'])){
    ...
    $sql = "UPDATE recados SET nome='$nome', email='$email', mensagens='$msg' WHERE id=$idatualiza";
...
<form method="post">
    ...
    <textarea name="msg"><?php echo htmlspecialchars($recado_editar['mensagens']); ?></textarea><br/>
...
if(mysqli_num_rows($seleciona) <= 0){
    ...
    while($res = mysqli_fetch_assoc($seleciona)){
        ...
        echo '<li><strong>Mensagens:</strong> ' . nl2br(htmlspecialchars($res['mensagens'])) . '</li>';
        echo '</ul>';
    }
}
?>
