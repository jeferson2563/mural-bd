...
if(isset($_POST['cadastra'])){
    ...
    $sql = "INSERT INTO recados (nome, email, mensagens) VALUES ('$nome', '$email', '$msg')";
...
$(document).ready(function() {
    $("#mural").validate({
        ...
        messages: {
            ...
            msg: { required: "Digite sua mensagens", minlength: "A mensagens deve ter no mínimo 10 caracteres" }
        }
    });
});
</script>
